...
import { Box, ChevronDown, Clock } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { TSIZE_DAYS, SIZE_MAPPING } from "@/constants/constants";
...
export function CheckoutTable() {
        ...
        `)
            ...
            const checkoutsWithDetails = await Promise.all(
                checkouts.map(async (checkout) => {
                    ...
                    const totalEffort = pbis?.reduce((total, pbi) => {
                        const size = SIZE_MAPPING[
                    ...
                    return {
                        ...checkout,
                        user_email: checkout.users[0]?.email || "",
    ...
    function setSelectedValue(arg0: string): void {
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            ...
                            >
                                {setSelectedValue} <ChevronDown className="h-4 w-4" />
                            </Button>
                        </DropdownMenuTrigger>
